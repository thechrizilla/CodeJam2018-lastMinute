...
public class uInterface extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Selected English-Language Comic File");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "French", "Spanish", "Mandarin", "Japanese", "Portuguese" }));
        ...
        jLabel1.setText("Destination Language:");

        jLabel2.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        jLabel2.setText("Welcome to MCCM Comic Book Translator");

        jButton2.setText("Translate Comic and Save");
